...
<html lang="es">
	<head>
		...
		<title><?php echo $nom_app; ?> | Administración de Transportistas</title>
	...
	<body class="bg-light" onload="f_SetDimension(); f_Init();" style="zoom: 80%;">
						...
						<div class="row" style="border: solid; border-width: 1px; border-color: #E6E9ED; border-radius: 7px; background-color: #ffffff;">
							<div class="row" style="padding: 20px;">
								<div class="col-md-10 col-sm-10 col-xs-10">
									<h5>Resumen de Transportistas</h5>
								</div>
		...
		<script type="text/javascript">
			function f_Init(){
				...
				// Titulo de Pantalla
					$("#nv_titulo").html('| Administración de Transportistas');
        ...
        $.post( "apis/backend.php", { accion: "get_listaclientes", cod_condicion: 2, cod_tipocliente: cod_tipocliente, cod_tipo: cod_tipo, txt_tipo: txt_tipo }, 
          function( data ) {
            if(data.estado == 1){
		...
		<script type="text/javascript">
          ...
          // Grabando Datos
            $.post( "apis/backend.php", { accion: "grabar_cliente", modo_grabar: modo_grabar, id_cliente: id_cliente, cod_condicion: 2, cod_tipocliente: cod_tipocliente, cod_tipodocumento: cod_tipodocumento, documento: documento, razon_social: razon_social, telefono1: telefono1, telefono2: telefono2, correo: correo, direccion: direccion, cod_cliente: '', representante_dni: '', representante_nombres: '',bancaria_id_banco: '',bancaria_num_cuenta: '',bancaria_cci: '',bancaria_id_mediopago: '',bancaria_id_moneda: '' },
              function( data ) {
                if (data.estado == 2){
