...
<html lang="es">
  ...
  <body class="bg-light" onload="f_SetDimension(); f_Init();" style="zoom: 80%;">
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12" style="border: solid; border-width: 1px; border-color: #E6E9ED; border-radius: 7px; padding-top: 10px;">
            <div class="d-flex">
              ...
              <div class="col-md-7 col-sm-7 col-xs-12" style="border: solid 1px #E6E9ED; border-radius: 7px; margin-right: 5px;">
                <div class="position-relative" style="padding: 13px; border: solid 1px #E6E9ED; border-radius: 7px; background-color: #cfaa41;">

                  <!-- Botón alineado a la derecha -->
                  <div style="position: absolute; right: 10px; top: 10px; cursor: pointer">
                    <button class="btn btn-success btn-sm" type="button" onclick="f_NuevaUnidadFicticia();" style="margin-top: -3px; color: #ffffff;">
                      <label style="cursor: pointer; font-size: 14px;">+ Unidad Ficticia</label>					
                    </button>
                  </div>
                  ...
                  <div class="text-center">
                    <h5 style="font-size: 14px; font-weight: bold; margin: 0;">
                      Validación de Unidades, Generación de Lotes y Peso Inicial de Lotes
                    </h5>
                  </div>

                  <!-- Loader debajo -->
                  <div id="wt_loadingingresounidades_validadcion" class="text-center" style="font-size: 12px; display: none; padding-top: 5px;">
                    <img src="<?php echo $img_waiting ?>" style="width: 20px;">
                    <label style="font-style: italic;"> Cargando datos...</label>
                  </div>
                </div>
            ...
            <div id="div_recepcion1">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                  <div class="d-flex">
                    <div class="flex-fill" style="max-width: 91%">
                      <select id="registro_condicion" class="form-select" data-placeholder="Elija una opción..." style="text-align: left;" data-titulo="Condición de Ingreso" onclick="f_ShowListaModal(this);">
              ...
              <div id="div_row4" class="row" style="padding: 5px;">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                  <div class="d-flex">
                    <div class="flex-fill" style="max-width: 91%">
                      <select id="registro_tipovehiculo" class="form-select" data-placeholder="Elija una opción..." data-titulo="Tipo de Vehículo" onclick="f_ShowListaModal(this);">
                        <option selected value="">Elija una opción...</option>
              ...
              <div id="div_row6" class="row" style="padding: 5px;">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                  <div class="d-flex">
                    <div class="flex-fill" style="max-width: 80%">
                      <select id="registro_conductor" class="form-select" data-placeholder="Elija una opción..." data-titulo="Conductores" onclick="f_ShowListaModal(this);">
              ...
              <div id="div_row7" class="row" style="padding: 5px;">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                  <div class="d-flex">
                    <div class="flex-fill" style="max-width: 91%">
                      <select id="registro_tipocarga" class="form-select" data-placeholder="Elija una opción..." data-titulo="Tipo de Carga" onclick="f_ShowListaModal(this);">
                        <option selected value="">Elija una opción...</option>
              ...
              <div id="div_row8" id="div_zonaorigen" class="row" style="padding: 5px;">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                  <div class="d-flex">
                    <div class="flex-fill" style="max-width: 80%">
                      <select id="registro_zonaorigen" class="form-select" data-placeholder="Elija una opción..." data-titulo="Zona de Origen" onclick="f_ShowListaModal(this);">
              ...
              <div id="div_row10" class="row" style="padding: 5px;">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                  <div class="d-flex">
                    <div class="flex-fill" style="max-width: 91%">
                      <select id="registro_proveedorminero" class="form-select" data-placeholder="Elija una opción..." data-titulo="Proveedor Minero" onclick="f_ShowListaModal(this);">
                        <option selected value="">Elija una opción...</option>
              ...
              <div id="div_row11" class="row" style="padding: 5px;">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                  <div class="d-flex">
                    <div class="flex-fill" style="max-width: 80%">
                      <select id="registro_encargado" class="form-select" data-placeholder="Elija una opción..." data-titulo="Encargado de Muestra" onclick="f_ShowListaModal(this);">
              ...
              <div id="div_row12" id="div_producto" class="row" style="padding: 5px;">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                  <div class="d-flex">
                    <div class="flex-fill" style="max-width: 91%">
                      <select id="registro_producto" class="form-select" data-placeholder="Elija una opción..." data-titulo="Producto" onclick="f_ShowListaModal(this);">
                        <option selected value="">Elija una opción...</option>
              ...
              <div id="div_row13" id="div_tipomaterial" class="row" style="padding: 5px;">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                  <div class="d-flex">
                    <div class="flex-fill" style="max-width: 91%">
                      <select id="registro_tipomaterial" class="form-select" data-placeholder="Elija una opción..." data-titulo="Tipo de Material" onclick="f_ShowListaModal(this);">
                        <option selected value="">Elija una opción...</option>
            ...
            <div style="border: solid; border-width: 1px; border-color: #E6E9ED; border-radius: 7px; padding: 5px; margin-bottom: 5px;">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                  <div class="d-flex">
                    <div class="flex-fill" style="max-width: 100%">
                      <select id="lote_tipocarga" class="form-select" data-placeholder="Elija una opción..." data-titulo="Tipo de Carga" onclick="f_ShowListaModal(this);">
                        <option selected value="">Elija una opción...</option>
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                  <div class="d-flex">
                    <div class="flex-fill" style="max-width: 87%">
                      <select id="lote_zonaorigen" class="form-select" data-placeholder="Elija una opción..." data-titulo="Zona de Origen" onclick="f_ShowListaModal(this);">
              ...
              <div class="d-flex" style="padding: 5px;">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                  <div class="d-flex">
                    <div class="flex-fill" style="max-width: 100%">
                      <select id="lote_proveedorminero" class="form-select" data-placeholder="Elija una opción..." data-titulo="Proveedor Minero" onclick="f_ShowListaModal(this);">
                        <option selected value="">Elija una opción...</option>
              ...
              <div class="d-flex" style="padding: 5px;">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                  <div class="d-flex">
                    <div class="flex-fill" style="max-width: 87%">
                      <select id="lote_encargado" class="form-select" data-placeholder="Elija una opción..." data-titulo="Proveedor Minero" onclick="f_ShowListaModal(this);">
                        <option selected value="">Elija una opción...</option>
                        ...
                        $q_proveedorminero = "SELECT Id,
                                                     documento,
                                                     UPPER(nombres) AS ENCARGADO_MUESTRA
                        ...
                        if ($res_proveedorminero = mysqli_query($enlace, $q_proveedorminero)){
                          if (mysqli_num_rows($res_proveedorminero) > 0) {
                            while($row_proveedorminero = mysqli_fetch_array($res_proveedorminero)){
                              ...
                              <option value="<?php echo $row_proveedorminero["Id"]; ?>"><?php echo $row_proveedorminero["documento"].' - '.$row_proveedorminero["ENCARGADO_MUESTRA"]; ?></option>
              ...
              <div class="d-flex" style="padding: 5px;">
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                  <div class="d-flex">
                    <input id="lote_numcontacto" type="number" class="form-control" style="text-align: center; font-size: 14px;">
                  </div>
                </div>
              </div>
              ...
              <div class="d-flex" style="padding: 5px;">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                  <div class="d-flex">
                    <div class="flex-fill" style="max-width: 100%">
                      <select id="lote_producto" class="form-select" data-placeholder="Elija una opción..." data-titulo="Producto" onclick="f_ShowListaModal(this);">
                        <option selected value="">Elija una opción...</option>
              ...
              <div class="d-flex" style="padding: 5px;">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                  <div class="d-flex">
                    <div class="flex-fill" style="max-width: 100%">
                      <select id="lote_tipomaterial" class="form-select" data-placeholder="Elija una opción..." data-titulo="Tipo de Material" onclick="f_ShowListaModal(this);">
                        <option selected value="">Elija una opción...</option>
    ...
    <script type="text/javascript">
      ...
      function f_NuevaUnidadFicticia(){
        if (!confirm("¿Está seguro de crear una nueva Unidad Ficticia?")){
          return;
        }

        // Creando Lote
          $.post( "apis/backend.php", { accion: "crear_UnidadFicticia"}, 
            function( data ) {
              if(data.estado == 1){
                f_LoadCards_All();
              }
      ...
      function f_GestionLotes(_id_ingreso, _id_lote, _cod_lote, _is_pesoinicial, _peso_inicial, _pesoinicial_observacion, _cod_aum, _num_ticket, balanza_id_tipocarga, balanza_id_zonaorigen, balanza_id_proveedorminero, balanza_id_encargadomuestra, balanza_id_producto, balanza_id_tipomineral, balanza_observacion, _num_contacto){
        // Setea título
          if (_is_pesoinicial == 1){
            $("#modal_gestionlotesLabel_a").html('Peso Inicial para Lote: ');
            $("#modal_gestionlotesLabel").html(_cod_lote);
          }
          else{
            $("#modal_gestionlotesLabel_a").html('Peso Final para Lote: ');
            $("#modal_gestionlotesLabel").html(_cod_aum + '<label style="color: #212529; margin-left: 5px; margin-right: 5px;"> | </label>' + _cod_lote);
          }
        ...
        // Limpiando campos
          ...
          // else{
            ...
            $("#lote_numcontacto").val(_num_contacto);
          // }
    ...
    <script type="text/javascript">
      ...
      function f_ValidacionCheck(_orden_objeto){
        ...
        // Validando datos
          if (_orden_objeto != 2 && _orden_objeto != 3 && _orden_objeto != 6 && _orden_objeto != 8 && _orden_objeto != 9 && _orden_objeto != 10 && _orden_objeto != 11 && _orden_objeto != 12 && _orden_objeto != 13){
            if (_valor == null){
              alert(_message);
      ...
      function f_ConfirmarLote(){
        // Obteniendo datos
          ...
          var _num_contacto = $("#lote_numcontacto").val();
              ...
              if(data.estado == 1){
                ...
                // MAX (15/04/2023 14:12): Debe imprimir tanto en el primer como en el segundo peso
                  // if (_is_pesoinicial == 0){
                    window.open('https://gelerp.intelli-apps.com/print_ticketbalanza_prev.php?x=' + data.id_md5);
                  // }
            ...
            function( data ) {
              if (data.estado == 2 || data.estado == 3){
                if (data.estado == 2){
                  ...
                  alert("Los Nombres y Apellidos ya fueron registrados anteriormente.\n\nPor favor verificar");
                }
