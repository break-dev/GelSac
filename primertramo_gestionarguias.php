									...
									<div class="col-md-12 col-sm-12 col-xs-12" style="padding: 2px;">
										<div style="border: solid; border-width: 1px; border-color: #E6E9ED; border-radius: 7px; padding: 10px;">
											...
											<div class="d-flex" style="margin-top: -5px; padding-left: 10px; padding-right: 10px;">
												<select id="filtro_guiaremitente" class="form-control" multiple data-placeholder="Elija una o más opciones..." style="font-size: 14px; border: solid; border-width: 1px; border-color: #BFBFBF; border-radius: 7px; max-height: 40px;">
														<?php
														...
														?>
																	...
																	<option value="<?php echo $row_guiaremitente["guia_remitente"]; ?>"><?php echo $row_guiaremitente["guia_remitente"]; ?></option>
						...
						<div class="row" style="padding: 0px;">
                          ...
                          <button id="btn_AddDistribucion" type="button" class="btn btn-primary" style="font-size: 14px; margin-top: -6px;" onclick="f_AddGuia();">+ Generar Guía</button>
									...
									<div class="col-md-12 col-sm-12 col-xs-12" style="padding-left: 20px; padding-right: 20px; margin-top: 5px; width: 100%;">
										<div class="table-container" style="margin-top: 5px; overflow-x: scroll; width: 100%; height: auto; margin-bottom: 20px;">
											<table class="table table-bordered table-hover">
							        	<thead>
							        		<tr style="font-size: 12px;">
							        			<th colspan="2" rowspan="2" style="text-align: center; border: solid; border-width: 1px; background-color: #816951; border-color: #ffffff; color: #ffffff; vertical-align: middle; border-top-left-radius: 15px; min-width: 35px;">
							        				N°
							        			</th>

                            <th colspan="2" rowspan="2" style="text-align: center; border: solid; border-width: 1px; background-color: #816951; border-color: #ffffff; color: #ffffff; vertical-align: middle;  min-width: 35px;">
							        				Guía Remitente
							        			</th>
                            ...
                            <th rowspan="2" style="text-align: center; border: solid; border-width: 1px; background-color: #816951; border-color: #ffffff; color: #ffffff; vertical-align: middle;  min-width: 35px;">
							        				Fecha Guía
							        			</th>  
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="row" style="padding: 5px;">
              ...
              <div class="col-md-3 col-sm-3 col-xs-12" style="margin-left: -20px;">
                <input id="guia_balanza_fecharegistro" type="date" class="form-control" style="text-align: center; font-size: 14px;" >
              </div>

              <div class="col-md-2 col-sm-2 col-xs-12" style="margin-left: -20px;">
                <input id="guia_balanza_horaregistro" type="time" class="form-control" style="text-align: center; font-size: 14px;" >
              </div>
            </div>
            ...
            <div class="row" style="padding: 5px;">
              ...
              <div class="col-md-8 col-sm-8 col-xs-12" style="margin-left: -20px;">
                <select id="guia_proveedor" class="form-select" data-placeholder="Elija una opción..." style="font-size: 14px;">
            ...
            <div class="row" style="padding: 5px;">
              ...
              <div class="col-md-8 col-sm-8 col-xs-12" style="margin-left: -20px;">
                <select id="guia_concesion" class="form-select" data-placeholder="Elija una opción..." style="font-size: 14px;">
                  <option selected value="">Elija una opción...</option>
                </select>
              </div>
            </div>
            ...
            <div class="row" style="padding: 5px;">
              ...
              <div class="col-md-8 col-sm-8 col-xs-12" style="margin-left: -20px;">
                <select id="guia_placa" class="form-select" data-placeholder="Elija una opción..." style="font-size: 14px;">
                  <option selected value="">Elija una opción...</option>
                  ...
                  ?>
                        ...
                        <option value="<?php echo $row_lista_placa["id_transporte"] ?>" data-codmtc="<?php echo $row_lista_placa["codigo_mtc"] ?>" data-idempresatransporte="<?php echo $row_lista_placa["id_Transportista"] ?>" data-capacidadunidad="<?php echo number_format($row_lista_placa["nCapacidad"]/1000,2) ?>" data-idmarca="<?php echo $row_lista_placa["id_marca"] ?>"><?php echo $row_lista_placa["cplaca"]  ?></option>
            ...
            <div class="row" style="padding: 5px;">
              ...
              <div class="col-md-8 col-sm-8 col-xs-12" style="margin-left: -20px;">
                <select id="guia_empresatransporte" class="form-select" data-placeholder="Elija una opción..." style="font-size: 14px;">
                  <option selected value="">Elija una opción...</option>
                </select>
              </div>
            </div>
            ...
            <div class="row" style="padding: 5px;">
              ...
              <div class="col-md-8 col-sm-8 col-xs-12" style="margin-left: -20px;">
                <select id="guia_placa2" class="form-select" data-placeholder="Elija una opción..." style="font-size: 14px;">
                  <option selected value="">Elija una opción...</option>
            ...
            <div class="row" style="padding: 5px;">
              ...
              <div class="col-md-8 col-sm-8 col-xs-12" style="margin-left: -20px;">
                <select id="guia_empresatransporte2" class="form-select" data-placeholder="Elija una opción..." style="font-size: 14px;">
                  <option selected value="">Elija una opción...</option>
                </select>
              </div>
            </div>
            ...
            <div class="row" style="padding: 5px;">
              ...
              <div class="col-md-8 col-sm-8 col-xs-12" style="margin-left: -20px;">
                <select id="guia_motivotraslado" class="form-select" data-placeholder="Elija una opción..." style="font-size: 14px;">
                  <option selected value="">Elija una opción...</option>
            ...
            <div class="row" style="padding: 5px;">
              <div class="d-flex justify-content-end">
                  <button id="btn_AddLote" type="button" class="btn btn-dark" style="font-size: 14px;" onclick="f_AddLote();">+ Agregar Lote</button>
                </div>
            </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12" >
                ...
                <table class="table table-bordered table-hover">
                  <thead>
                    ...
                    <tr style="font-size: 12px;">
                      <th colspan="2" style="text-align: center; background-color: #816951; border: solid 1px #ffffff; color: #ffffff; vertical-align: middle;">N°</th>
                      <th rowspan="2" style="text-align: center; background-color: #816951; border: solid 1px #ffffff; color: #ffffff; vertical-align: middle;">Lote</th>
                      <th rowspan="2" style="text-align: center; background-color: #816951; border: solid 1px #ffffff; color: #ffffff; vertical-align: middle;">P. Bruto</th>
                      <th rowspan="2" style="text-align: center; background-color: #816951; border: solid 1px #ffffff; color: #ffffff; vertical-align: middle;">Tara</th>
                      <th rowspan="2" style="text-align: center; background-color: #816951; border: solid 1px #ffffff; color: #ffffff; vertical-align: middle;">P. Neto</th>
                    </tr>
            ...
            <div class="d-flex" style="padding: 5px; margin-top: -10px; font-size: 14px;">
              ...
              <input id="guia_capacidadunidad" type="text" class="form-control" style="text-align: center; font-size: 14px; width: 80px;" disabled >
          ...
          <div class="modal-footer" style="margin-top: -10px;">
            ...
            <button type="button" class="btn btn-primary wt_grabarprogramacion_button" style="font-size: 14px;" onclick="f_EmitirGuia();">Emitir Guías</button>
          </div>
        </div>
      </div>
    </div>

    <div class="modal fade modal-dialog-scrollable" id="modal_adminlotes" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modal_adminlotesLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
          ...
          <div class="modal-body">
            ...
            <div class="row" style="padding: 5px;">
              ...
              <div class="col-md-8 col-sm-8 col-xs-12" style="margin-left: -20px;">
                <select id="guia_lote" class="form-select" multiple data-placeholder="Elija opciones..." style="font-size: 14px;">
                </select>
              </div>
            </div>
          ...
          <div class="modal-footer" style="margin-top: -10px;">
            ...
            <button type="button" class="btn btn-warning" style="font-size: 14px;" onclick="f_AgregarLotes();">Confirmar Lotes</button>
          </div>
        </div>
      </div>
    </div>
