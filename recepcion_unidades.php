...
<html lang="es">
  ...
  <body class="bg-light" onload="f_SetDimension(); f_Init();" style="zoom: 80%;">
                ...
                <div class="row" style="padding-left: 20px;margin-top: 10px;margin-bottom: 10px;font-size: 13px;padding-right: 20px;">
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12" style="padding: 2px;">
                    <div style="border: solid; border-width: 1px; border-color: #E6E9ED; border-radius: 7px; padding: 10px;">
                      ...
                      <div class="d-flex" style="margin-top: -5px; padding-left: 10px; padding-right: 10px;">
                        <div class="flex-fill">
                          <select id="filtro_condicioningreso" class="form-select" data-placeholder="Elija una opción..." data-titulo="Condición Ingeso" onclick="f_ShowListaModal(this);" style="font-size: 14px;">
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12" style="padding: 2px;">
                    <div style="border: solid; border-width: 1px; border-color: #E6E9ED; border-radius: 7px; padding: 10px;">
                      ...
                      <div class="d-flex" style="margin-top: -5px; padding-left: 10px; padding-right: 10px;">
                        <div class="flex-fill">
                          <select id="filtro_transportista" class="form-select" data-placeholder="Elija una opción..." style="text-align: left; font-size: 14px;" data-titulo="Empresas de Transporte" onclick="f_ShowListaModal(this);">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button id="btn_ConfirmarAcompanantes" type="button" class="btn btn-success wt_grabarregistro_button" style="font-size: 14px;" onclick="f_GrabarRecepcion_Confirmar();">Grabar</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <script type="text/javascript">
      // Lista de Unidades
        // $('#registro_unidad, #registro_transportista, #registro_tipovehiculo, #registro_conductor, #registro_tipocarga, #registro_zonaorigen, #registro_placasdespacho').select2({
        //   theme: "bootstrap-5",
    ...
    <script type="text/javascript">
      ...
      function f_ShowListaPlacasDespacho(_id_placa){
        ...
        // Cargando lista de Placas para Despacho
          var _html = '<option></option>';
          _html += '<option value="9.9" style="font-size: 14px; color: #0099DD;">*La Placa no se encuentra en la lista*</option>';
