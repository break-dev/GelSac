					...
					function( data ) {
						if(data.estado == 1){
							...
							$.each( data.res, function( key, val ) {
								...
								_html += ' <button class="btn btn-success " type="button" title="Reporte" style="font-size: 14px; padding: 5px; width: 30px; margin-bottom: 5px" onclick="f_ReporteGestionDocumentaria('+val.Id+", '"+val.documento+"','"+val.razon_social+"',"+val.cod_tipocliente+')">'
											...
											$.ajax({
												...
												success: function(data3) {
													if (data3.estado == 1) {
														...
														array_valor_tipo_dato += val.cod_tipo_dato + "|" +val.input_value +"$";
